const rawEpisodes = [
  {
    ...
    episodes: [
      ...
      {title: "Trio Luna Meets Dumbo"}, //debut de Jake, Jenna y las cutie mark crusaders 
      ...
      { title: "Trio Luna, Mickey and the Beanstalk"}, //debut de Ariel, Cream y Maria Robotnik seran rescatadas del gigante y se uniran al final
      { title: "Trio Luna's Adventures of The Lion King" }, //debut de Cream y Maria Robotnik, Rey Sombra, Magica De hechizos, Bill Cipher y Lord Dominador se aliaran con Scar, y el trio luna se transformaran en animales de africa
